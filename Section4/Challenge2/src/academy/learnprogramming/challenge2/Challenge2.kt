...
fun main(args: Array<String>) {
    ...
    val floatOne = -3847.384f // preferred
    val floatTwo: Float = -3847.384f
    val floatThree = (-3847.384).toFloat()

    // 2. Now change both of those variable declarations into nullable variables.
    val nullableFloatOne: Float? = -3847.384f
    val nullableFloatThree: Float? = (-3847.384).toFloat()

    // 3. Now declare an array of type non-nullable Short.
    // Make it size 5, and assign it the values 1, 2, 3, 4 and 5
    val shortArray = shortArrayOf(1, 2, 3, 4, 5)
    val shortArrayTwo: Array<Short> = arrayOf(1, 2, 3, 4, 5)
    val shortArrayThree = arrayOf<Short>(1, 2, 3, 4, 5)
...
//    }
    ...
    // Declare an array that you could pass to the method and initialize it with the values
    // 'a', 'b' and 'c'.
    ...
    // (a) lowercase the string, and then
